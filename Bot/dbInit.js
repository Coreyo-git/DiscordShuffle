...
const UserShuffle = require("./models/UserShuffle.js")(
    sequelize,
    Sequelize.DataTypes
);
...
sequelize
    .sync({ force })
    .then(async () => {
        const shuffles = [Shuffle.upsert({ id: 1, genre: "Shonen" })];

        const users = [
            Users.upsert({
                id: 1,
                user_id: "352040458098311168",
                username: "Corey#9390",
                nickname: "Coreyo",
                anime_list_url: "",
            }),
            Users.upsert({
                id: 2,
                user_id: "352040458098311167",
                username: "Jhonny#1290",
                nickname: "Jhonny",
                anime_list_url: "",
            }),
        ];
        ...
        const userShuffles = [
            UserShuffle.upsert({
                user_1_id: "352040458098311168",
                user_2_id: "352040458098311167",
                shuffle_id: 1,
            }),
        ];
